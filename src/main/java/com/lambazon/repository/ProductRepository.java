...
public class ProductRepository {
	...
	private static void generateProductData() {
		...
		products.put(++id, new Product(id, 60, 138.99, "Nintendo 3DS XL", "Console")); //product add for system test
		products.put(++id, new Product(id, 70, 900.00, "Acer E325-85", "Laptop")); //product add for system test
	}
